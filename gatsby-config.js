...
module.exports = {
  ...
  plugins: [
    ...
    },
    {
      ...
      options: {
        threshold: 0.9, // Percentage of an element's area that needs to be visible to launch animation
    ...
    `gatsby-plugin-sharp`,
    {
      ...
      options: {
        ...
        theme_color: `#663399`,
        display: `minimal-ui`,
        icon: `src/images/night-mode.png`, // This path is relative to the root of the site.
      },
    },
